"""Exploratory: how does AVES represent violin vs piano vs bird vocalizations?

Extracts frame-level embeddings from all 12 layers for violin, piano, and
bird recordings, reduces to 2D with PCA, and plots each layer colored by source.
"""
...
fig.suptitle("AVES Layer Representations: Bird vs Piano vs Violin\n(PCA → 2D, each dot = one 20ms frame)",
...
plt.tight_layout()
plt.savefig("violin_piano_bird_pca.png", dpi=150, bbox_inches="tight")
print(f"\nSaved plot to violin_piano_bird_pca.png")

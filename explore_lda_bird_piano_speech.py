"""LDA: how well does each AVES layer linearly separate bird vs piano vs human speech?
...
fig.suptitle("AVES Layer Representations: Bird vs Piano vs Human Speech (LDA → 2D)\n"
...
plt.tight_layout()
plt.savefig("lda_bird_piano_speech.png", dpi=150, bbox_inches="tight")
print(f"\nSaved scatter plot to lda_bird_piano_speech.png")
...
ax2.set_title("3-Way LDA Accuracy Across AVES Layers\n(Bird vs Piano vs Human Speech)", fontsize=13, fontweight="bold")
...
plt.tight_layout()
plt.savefig("lda_bird_piano_speech_accuracy.png", dpi=150, bbox_inches="tight")
print(f"Saved accuracy curve to lda_bird_piano_speech_accuracy.png")
